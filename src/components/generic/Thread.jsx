  ...
  return (
    <ul className={`thread`}>
        ...
        <li key={key} className={`thread-item`}>
          ...
          <div className={`thread-item-content`}>
            ...
            <div className={`badges pt-1`}>
              ...
              {item.place && (
                <InfoBadge faIcon={`fa-solid fa-building`} text={item.place} />
              )}
            </div>
            ...
            <div className={`link-wrapper ${item.href ? 'mt-4' : 'mt-2'}`}>
              {item.href && (
                /* <ExternalLink
                  className={`link font-family-subheadings fw-bold text-2`}
                  href={item.href}
                >
                ...
                /* <Link to={item.href}>More Info</Link> */
                <a href="">hehe</a>
              )}
            </div>
          </div>
      ...
      <li className={`thread-item trailing-thread-item`}>
        <div className="fa fa-stack circle">
          <FaIcon
            iconName={shouldShowAsComplete ? '' : 'fa-solid fa-caret-down'}
          />
        </div>
      </li>
    </ul>
